          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Button
                  disabled={!meetingId}
                  className="w-full text-xs sm:text-sm group bg-white/85 text-green-700 hover:bg-white/90 font-semibold cursor-pointer shadow-xl transition-all duration-150 ease-in-out"
                >
